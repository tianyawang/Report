<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Reports.Master" Inherits="System.Web.Mvc.ViewPage<ReportModel.Truck6ReportModel>" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h2>
        6轴车录入</h2>
    <hr />
    <%using (Html.BeginForm("Truck6Report", "report", FormMethod.Post))
      { %>
    <div class="item">
        <div class="title">
            月份</div>
